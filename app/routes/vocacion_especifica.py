...
from app.services.vocacion_especifica import get_all_vocaciones_especificas, get_vocacion_especifica_by_id, get_vocacion_especifica_by_valor, create_vocacion_especifica, update_vocacion_especifica, delete_vocacion_especifica
